-- Wiktoria Woronowicz, model fizyczny
...
INSERT INTO egzemplarz VALUES (1, 2019, '514W81DGT3'), 
(2, 2017, '76SDH8720P'),
(3, 2006, '74H5J22HBP'),
(4, 1826, '22HG45HJ32'),
(5, 2010, 'HUE229U31Q');
...
INSERT INTO studenci VALUES (1, 'jannowak123', 'haslohaslo123', 123456 , 'Jan', 'Nowak', 'Wrocław', 'Świdnicka', '3', '26', '50-064'),
(2, 'patrycjakwiatek123', 'haslopatki123', 824865, 'Patrycja', 'Kwiatek', 'Inowrocław', 'Kasztelańska', '8', '3', '88-110'),
(3, 'hubertmuszka', 'haslomuszki321', 874412, 'Hubertus', 'Muszkus', 'Warszawa', 'Filtrowa', '9', '1', '00-001'),
(4, 'richardrichy', 'richhaslo', 873152, 'Rich', 'Richard', 'Eindhoven', 'Willem Barentzstraat', '26', '-', '5612 KL'),
(5, 'grzesiupaszkiewicz', 'grzesiahaslo123', 124775, 'Grzegorz', 'Paszkiewicz', 'Berlin', 'Ohmstraße', '12', '12', '10179');
...
dzielo_id INT(10) DEFAULT NULL,
egz_id INT(10) DEFAULT NULL,
rezerwacji_id INT(10) DEFAULT NULL,
...
INSERT INTO detal VALUES (1,1,2,1), (2,4,1,2), (3,5,3,4), (4,2,4,3), (5,3,4,5);